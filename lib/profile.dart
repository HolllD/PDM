...
class ProfileScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // height: 896, width: 414, allowFontScaling: true
                  ...
                  child: ListView(
                    children: <Widget>[
                      ProfileListItem(
                        ...
                        text: 'Privacy', key: null,
                      ),
                      ProfileListItem(
                        icon: LineAwesomeIcons.history,
                        text: 'Purchase History', key: null,
                      ),
                      ProfileListItem(
                        icon: LineAwesomeIcons.question_circle,
                        text: 'Help & Support', key: null,
                      ),
                      ProfileListItem(
                        icon: LineAwesomeIcons.cog,
                        text: 'Settings', key: null,
                      ),
                      ProfileListItem(
                        icon: LineAwesomeIcons.user_plus,
                        text: 'Invite a Friend', key: null,
                      ),
                      ProfileListItem(
